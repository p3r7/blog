...
Oversawn by Brian (@tehn), Dan and Tyler Etter started playing seriously with the idea of a wiki so that knowledge between _script_ creators and users could be shared.

Before that, the forum was used but it was tedious to find back technical information buried deep bewteen more general posts.
