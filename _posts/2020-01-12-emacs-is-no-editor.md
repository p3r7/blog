...
[Irreal](https://irreal.org/blog/) blog [picked up on this article](https://irreal.org/blog/?p=8809). This analysis is worth reading, notably this correction regarding Emacs original vision and design decision:
...
[Karl Voit](https://karl-voit.at/) made a similar statement [back in 2015](https://karl-voit.at/2015/10/23/Emacs-is-not-just-an-editor/), presenting Emacs as a `LISP interpreter and thus [...] very capable highly dynamic platform`. One other highlight is `comparing Emacs to an editor is [...] unfair and inadequate [...]. Those stupid editor flame-wars are not worth the time at all.`.

[Two Wrongs blog](https://two-wrongs.com/) features [a post back in 2018](https://two-wrongs.com/why-you-should-buy-into-the-emacs-platform) that makes the same statement but with other words: `Emacs is a platform for developing end-user applications with a text-based core`.
...
[^1]: The "end" being to build a text editing tool. Furthermore this vision was not present unil later Emacs iterations.
